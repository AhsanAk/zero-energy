 ...
 * @since 1.0.0
 */
class Projects_4_Column extends Widget_Base {
    ...
    public function get_name() {
        return 'energo_projects_4_column';
    }
    ...
    public function get_title() {
        return esc_html__('Projects 4 Column', 'energo');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'projects_4_column',
            [
                'label' => esc_html__('Projects 4 Column', 'energo'),
            ]
        );
        $this->add_control(
            'number',
    ...
    protected function render() {
        ...
        if($query->have_posts())
        {
						...
						foreach($post_terms as $p_term)
							...
							<div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all <?php echo esc_attr($term_slug); ?>">
								<div class="project-block-one">
									<div class="inner-box">
										<figure class="image-box"><?php the_post_thumbnail('energo_370x370'); ?></figure>
			...
			<!-- project-section -->
			<section class="project-section sec-pad portfolio-page-3">
