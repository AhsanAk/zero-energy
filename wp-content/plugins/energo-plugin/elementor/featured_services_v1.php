 ...
 * @since 1.0.0
 */
class Featured_Services_V1 extends Widget_Base {
    ...
    public function get_name() {
        return 'energo_featured_services_v1';
    }
    ...
    public function get_title() {
        return esc_html__( 'Featured Services V1', 'energo' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Featured Services V1', 'energo' ),
            ]
        );
        $this->add_control(
            'subtitle',
                        ...
                        <div class="service-block-one wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="inner">
                                    ...
                                    <div class="icon-box"><i class="icon <?php echo esc_attr($service_icon);?>"></i></div>
                                ...
                                <figure class="image-box"><?php the_post_thumbnail('energo_270x160'); ?></figure>
                            </div>
                        </div>
                    </div>
					<?php endwhile; ?>
