 ...
 * @since 1.0.0
 */
class Projects_3_Column extends Widget_Base {
    ...
    public function get_name() {
        return 'energo_projects_3_column';
    }
    ...
    public function get_title() {
        return esc_html__('Projects 3 Column', 'energo');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'projects_3_column',
            [
                'label' => esc_html__('Projects 3 Column', 'energo'),
            ]
        );
		$this->add_control(
            'subtitle',
