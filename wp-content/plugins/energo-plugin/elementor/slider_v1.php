...
class Slider_V1 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Slider V1', 'energo' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'slider_v1',
            [
                'label' => esc_html__( 'Slider V1', 'energo' ),
            ]
        );
        $this->add_control(
            'slides',
            [
                ...
                'fields' =>
                    [
                        ...
                        [
                            'name' => 'video_url',
                            'label' => esc_html__('Video URL', 'energo'),
                        ...
                        [
                            'name' => 'transparent_text',
                            'label' => esc_html__('Transparent Text', 'energo'),
                            'type' => Controls_Manager::TEXT,
							'label_block' => true,
                        ],
                    ],
                ...
                <div class="slide-item">
                    ...
                    <div class="auto-container">
                        <div class="content-box">
                            ...
                            <div class="video-btn">
                                <a href="<?php echo esc_url( $item['video_url'] ); ?>" class="vid-pp video-btn" data-flashy-type="video"><i class="flaticon-play-button"></i>
                            ...
                            <h6><?php echo wp_kses($item['text'], true); ?></h6>
							...
							<?php } ?>
                            <span class="big-text"><?php echo wp_kses($item['transparent_text'], true); ?></span>
                        </div> 
                    </div>
                </div>
                <?php endforeach; ?>
