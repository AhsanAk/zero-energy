 ...
 * @since 1.0.0
 */
class Latest_Projects_V1 extends Widget_Base {
    ...
    public function get_name() {
        return 'energo_latest_projects_v1';
    }
    ...
    public function get_title() {
        return esc_html__( 'Latest Projects V1', 'energo' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'latest_projects_v1',
            [
                'label' => esc_html__( 'Latest Projects V1', 'energo' ),
            ]
        );
        $this->add_control(
            'subtitle',
            ...
            <div class="auto-container">
                ...
                <div class="sortable-masonry">
                    <div class="items-container row clearfix">
                        ...
                        <div class="col-md-6 col-sm-12 masonry-item <?php echo esc_attr($class); ?>">
                            <div class="project-block-one">
                                <div class="inner-box">
                                    <figure class="image-box"><?php the_post_thumbnail($image_size); ?></figure>
                                    <div class="text"><h6>[ <?php echo implode( ', ', (array)$term_list ); ?> ]</h6></div>
