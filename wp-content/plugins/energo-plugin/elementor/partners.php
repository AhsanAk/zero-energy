...
class Partners extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Partners', 'energo' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'partners',
            [
                'label' => esc_html__( 'Partners', 'energo' ),
            ]
        );
		$this->add_control(
            'style',
            [
                ...
                'options' => array(
                    ...
                    'style3' => esc_html__( 'Style 3', 'energo' ),
                ),
            ]
        );
		$this->add_control(
    ...
    protected function render() {
            ...
            <div class="auto-container">
                <div class="clients-carousel owl-carousel owl-theme owl-nav-none owl-dots-none">
                    ...
                    <div class="clients-logo-box">
                        <a href="<?php echo esc_url( $item['link']['url'] ); ?>"><img src="<?php echo esc_url(wp_get_attachment_url($item['image']['id'])); ?>" alt="<?php echo esc_attr($item['title']); ?>"></a>
                    </div>
					<?php } ?>
                </div>
            </div>
		...
		<!-- clients-section -->
        <section class="clients-section alternat-3">
            <div class="auto-container">
                <div class="clients-carousel owl-carousel owl-theme owl-nav-none owl-dots-none">
                    <?php foreach($settings['slides'] as $key => $item) { ?>
                    <div class="clients-logo-box">
