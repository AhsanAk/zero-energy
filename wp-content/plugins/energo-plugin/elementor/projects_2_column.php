 ...
 * @since 1.0.0
 */
class Projects_2_Column extends Widget_Base {
    ...
    public function get_name() {
        return 'energo_projects_2_column';
    }
    ...
    public function get_title() {
        return esc_html__( 'Projects 2 Column', 'energo' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'projects_2_column',
            [
                'label' => esc_html__( 'Projects 2 Column', 'energo' ),
            ]
        );
        $this->add_control(
            'subtitle',
    ...
    protected function render() {
		...
		<!-- project-section -->
        <section class="project-section sec-pad portfolio-page-1">
                        ...
                        <div class="project-block-two">
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <figure class="image"><?php the_post_thumbnail('energo_570x380'); ?></figure>
                                </div>
