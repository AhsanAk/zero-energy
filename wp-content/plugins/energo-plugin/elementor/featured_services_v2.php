 ...
 * @since 1.0.0
 */
class Featured_Services_V2 extends Widget_Base {
    ...
    public function get_name() {
        return 'energo_featured_services_v2';
    }
    ...
    public function get_title() {
        return esc_html__( 'Featured Services V2', 'energo' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Featured Services V2', 'energo' ),
            ]
        );
        $this->add_control(
            'text_limit',
        ...
        <section class="service-style-three">
            <div class="outer-container clearfix">
                ...
                <div class="service-block-three">
                    <div class="inner-box">
                        <div class="upper-box">
                            <span class="big-text"><?php echo wp_kses(sprintf('%02d', $i), true); ?>.</span>
                            <div class="inner">
                                ...
                                <h5><a href="<?php echo esc_url(get_post_meta( get_the_id(), 'ext_url', true )); ?>"><?php the_title(); ?></a></h5>
                            </div>
                        </div>
                        <div class="lower-box">
                            <figure class="image-box"><?php the_post_thumbnail('energo_540x300'); ?></figure>
                            <div class="link"><a href="<?php echo esc_url(get_post_meta( get_the_id(), 'ext_url', true )); ?>"><i class="flaticon-right-arrows"></i></a></div>
                            <div class="overlay-content">
                                <div class="text">
                                    <p><?php echo wp_kses(energo_trim(get_the_content(), $settings['text_limit']), true); ?></p>
                                </div>
                                <div class="btn-box"><a href="<?php echo esc_url(get_post_meta( get_the_id(), 'ext_url', true )); ?>"><i class="flaticon-right-arrows"></i><span><?php esc_html_e('More', 'energo'); ?></span></a></div>
                            </div>
                        </div>
                    </div>
                </div>
