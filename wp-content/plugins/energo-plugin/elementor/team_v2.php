...
class Team_V2 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Team V2', 'energo' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'team_v2',
            [
                'label' => esc_html__( 'Team V2', 'energo' ),
            ]
        );
		$this->add_control(
            'style',
    ...
    protected function render() {
        ...
        <!-- team-style-two -->
        <section class="team-style-two sec-pad <?php if($settings['style'] == 'gray') echo 'bg-color-1'; ?>">
