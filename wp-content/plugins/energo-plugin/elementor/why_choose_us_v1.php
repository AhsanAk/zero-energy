 ...
 * @since 1.0.0
 */
class Why_Choose_Us_V1 extends Widget_Base {
    ...
    public function get_name() {
        return 'energo_why_choose_us_v1';
    }
    ...
    public function get_title() {
        return esc_html__( 'Why Choose Us V1', 'energo' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'why_choose_us_v1',
            [
                'label' => esc_html__( 'Why Choose Us V1', 'energo' ),
            ]
        );
		$this->add_control(
            'bg_image',
    ...
    protected function render() {
        ...
        <!-- working-style-two -->
        <section class="working-style-two bg-color-2 sec-pad">
            ...
            <div class="auto-container">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 working-block">
                        <div class="working-block-two wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="icon-box">
									...
									<?php if($item['link']) { ?>
                                    <a href="<?php echo esc_url( $item['link'] ); ?>"><i class="flaticon-right-arrows"></i></a>
									<?php } ?>
                                </div>
