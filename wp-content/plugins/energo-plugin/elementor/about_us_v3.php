...
class About_Us_V3 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'About Us V3', 'energo' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'about_us_v3',
            [
                'label' => esc_html__( 'About Us V3', 'energo' ),
            ]
        );
        $this->add_control(
            'subtitle',
    ...
    protected function render() {
        ...
        <!-- about-section -->
        <section class="faq-section sec-pad-2">
            <div class="auto-container">
                <div class="row clearfix">
                                ...
                                <ul class="accordion-box">
                                    ...
                                    <li class="accordion block <?php if($i==1) echo 'active-block'; ?>">
                                        <div class="acc-btn <?php if($i==1) echo 'active'; ?>">
                                            <div class="icon-outer"><i class="flaticon-right-arrows"></i></div>
                                        ...
                                        <div class="acc-content <?php if($i==1) echo 'current'; ?>">
                                            <div class="text">
                                                ...
                                                <a href="<?php echo esc_url( $item['btn_link']['url'] ); ?>"><i class="flaticon-right-arrows"></i><?php echo wp_kses($item['btn_title'], true); ?></a>
												<?php } ?>
                                            </div>
                                        </div>
                                    </li>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 image-column">
                        <div class="image-box">
                            <figure class="image"><img src="<?php echo esc_url(wp_get_attachment_url($settings['image']['id'])); ?>" alt="<?php esc_html_e('Awesome Image', 'energo'); ?>"></figure>
                        </div>
                    </div>
                </div>
            </div>
