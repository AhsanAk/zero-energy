...
class Services_V3 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Services V3', 'energo' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'services_v3',
            [
                'label' => esc_html__( 'Services V3', 'energo' ),
            ]
        );
		$this->add_control(
            'bg_color',
            [
                'label'   => esc_html__( 'Background Color', 'energo' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'white',
                'options' => array(
                    'white' => esc_html__( 'White', 'energo' ),
                    'gray' => esc_html__( 'Gray', 'energo' ),
                ),
            ]
        );
        $this->add_control(
    ...
    protected function render() {
        ...
        <!-- service-style-four -->
        <section class="service-style-four alternat-2 <?php if ($settings['bg_color'] == 'gray') echo 'sec-pad bg-color-1'; ?>">
