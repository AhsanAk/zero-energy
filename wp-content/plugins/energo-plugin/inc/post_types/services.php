...
namespace ENERGOPLUGIN\Inc\Post_Types;

use ENERGOPLUGIN\Inc\Abstracts\Post_Type;
 ...
 *
 * @version  2.6.0
 * @package  ENERGOPLUGIN/Abstracts
...
class Services extends Post_Type {
	...
	public static function init() {
		...
		self::instance()->menu_name = esc_html__( 'Services', 'energo' );
		self::instance()->singular  = esc_html__( 'Service', 'energo' );
		self::instance()->plural    = esc_html__( 'Services', 'energo' );
